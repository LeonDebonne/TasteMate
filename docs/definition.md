...
De definition fase begon met een sprint-dag. Hier werden enkele ontwerpeisen opgesteld als inzichten van de discovery fase. Uit deze eisen vloeide een storyboard die het proces van het gebruik van de koelkast met ons concept voorstelt.[Storyboard](/img/Storyboard.png) 
