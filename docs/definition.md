...
Lewat je aftog uit en toon welke prototypes gemaakt werden en hoe deze helpen om de onderzoeksvragen te beantwoorden (benoemen etst & link naar design requirements).   
...
#### WAVE 2
Het doel van wave 2 was om onderzoek te voeren naar het interface van het ontwerp en de functies hiervan. Om dit voorstelbaar te maken werden er twee interfaces gemaakt via FigmaMake. Via roleplaying werd er gekeken hoe de doorsnee gebruiker werkte met het interface.
...
![PrototypeWave2](/img/PrototypeWave2.JPG)
...
**Interface 1 :** De lay-out van het interface bleek efficiënt en eenvoudig voor doorsnee gebruikers. De grootte van de tekst en functieknoppen op het scherm was te klein als slechtziende personen dit ook zouden willen gebruiken.  Een functie die overbodig scheen te zijn voor visueel beperkte personen was de locatie van de voeding die werd voorgelezen door de AI -assistent. Bij het toevoegen van een kassabon werd er gevraagd om een pop-up toe te voegen die samenvat welke producten er gescand zijn. Zo kunnen foutieve producten gefilterd worden.
